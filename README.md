...
> branch contains the runtime used for *JustFit: 320K-Token Serving for a 27B
> LLM on a 24 GiB Laptop with Just-in-Time State Management*. Read the
...
> full 240K-input + 16K-output native-window capacity protocol. These fork-only mechanisms
